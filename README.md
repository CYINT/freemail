...
- A static webmail preview shell with inbox, paginated search and folder loading, thread-aware message hints, message reader, read/unread and star controls, bulk message actions, persistent preferences/signatures, compose, draft saving and editing, folder navigation, token-gated admin setup, and responsive layout QA.
- An Expo/React Native mobile client scaffold with secure session storage, paginated and thread-aware mailbox workflows, persistent preferences/signatures, draft saving and editing, read/unread and star controls, bulk archive/spam/delete/read/star actions, and static QA.
