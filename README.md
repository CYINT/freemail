...
Each completed EAS workflow run uploads a credential-free `workflow-summary.json` artifact with run metadata and collector command templates, but operators must still record real build and store evidence through the mobile collectors.
