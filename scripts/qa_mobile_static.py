...
def validate_mobile(root: Path) -> list[str]:
    ...
    files = {
        ...
        "mobile signing readiness": root / "scripts" / "mobile_signing_readiness.py",
    ...
    for marker in [
        ...
        "workflow_dispatch",
        "EXPO_TOKEN",
        "mobile_signing_readiness.py",
        "signingReadinessCommand",
        "gh secret list",
        "workflow-summary.json",
        "actions/upload-artifact@v4",
        "freemail-mobile-eas-workflow-summary",
        "\"credentialFree\": true",
        "\"expoTokenConfigured\"",
        "\"readyToLaunchEas\"",
