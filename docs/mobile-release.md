...
Before launching EAS, verify that GitHub Actions can see the workflow and the required secret names:

```powershell
.\.venv\Scripts\python.exe scripts\mobile_signing_readiness.py --repo CYINT/freemail
```
