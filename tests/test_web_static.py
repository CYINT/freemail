...
def test_static_web_validation_flags_credential_storage():
    ...
    failures = _validate(
        ...
        "deleteMailboxSenderRule(1); renderMailboxSenderRules([]); saveSelectedSenderRule('block'); "
        "senderEmailFromText('Sender <sender@example.net>'); allow-sender-action; block-sender-action; sender-rules-refresh; "
