...
- Inbox snapshot, message read, compose/send with Sent Items persistence status, reply, forward, mark read/unread, archive, spam, delete, and sign-out workflows.
