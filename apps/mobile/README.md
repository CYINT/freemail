...
- Attachment metadata display, authenticated download/share handling, single-message EML export/share, and bounded document-picker compose attachments.
