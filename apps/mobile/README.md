...
- Paginated and thread-aware inbox snapshot/search, message read, mailbox preferences/signatures, compose/send with Sent Items persistence status, save draft, reply, forward, mark read/unread, bulk read/star/archive/spam/delete actions, and sign-out workflows.
